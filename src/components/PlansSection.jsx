...
// Exibe os planos disponíveis com seus recursos e preços
      ...
      <div className="container py-4">
        ...
        <div className="row g-4 justify-content-center align-items-start">
          {plans.map((plan) => (
            ...
            >
              <div
                className={`card border-0 shadow-sm rounded-4 h-100 overflow-hidden ${plan.featured ? "border border-success border-2 shadow-lg" : ""}`}
              >
                {/* Badge de destaque */}
                {plan.featured && (
                  <div className="bg-success text-white text-center py-2 small fw-bold tracking-wide">
                    ✦ Mais popular
                  </div>
                )}
